...
const SSOCardStack = () => {
  ...
  return (
    ...
    >
      ...
      >
        {stackOffsets.map((offset: number, slotIndex: number) => {
          ...
          return (
            ...
            >
              {cardSrc(card) && (
                <img src={cardSrc(card)} height={400} width={400} className="absolute z-[-1] h-full w-full top-0 left-0 object-cover" alt="" />
              )}
          ...
          >
            {cardSrc(leavingCard) && (
              <div
                ...
                style={{ backgroundImage: `url(${cardSrc(leavingCard)})` }}
              />
            )}
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-5">
